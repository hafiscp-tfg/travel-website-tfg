...
import { CheckCircle, Clock, FileText, Globe, Headset, Rocket, Users } from 'lucide-react';
...
const visaHeroImage = PlaceHolderImages.find(p => p.id === 'visa-hero-background');
...
const whyChooseUsItems = [
    {
        ...
        description: "Our experienced team provides step-by-step assistance to ensure your application is perfect."
    },
    {
        icon: Rocket,
        title: "Fast Processing",
        description: "We prioritize your application to minimize waiting times and get your visa approved quickly."
    },
    {
        icon: Headset,
        title: "Dedicated Support",
        description: "Have questions? Our support team is available around the clock to assist you at every stage."
    }
]
    ...
    return (
        <div className="bg-background">
            <section className="relative w-full">
                {visaHeroImage &&
                    <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.5) 100%), url('${visaHeroImage.imageUrl}')` }}></div>
                }
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex min-h-[400px] md:min-h-[480px] flex-col gap-6 items-start justify-end p-6 md:p-10">
                            ...
                            <div className="flex border-b border-border gap-8">
                                {visaTypes.map(visa => (
                                    <Link
                                        key={visa.name}
                                        href="#"
                                        className={`flex flex-col items-center justify-center border-b-[3px] pb-[13px] pt-4 transition-colors ${visa.active ? 'border-b-primary text-foreground' : 'border-b-transparent text-muted-foreground hover:text-foreground'
                                            }`}
                                    >
            ...
            <section className="bg-card py-16 sm:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-4 text-lg leading-8 text-muted-foreground">Your trusted partner in navigating the complexities of global travel.</p>
                    </div>
